...
class MongoKLStore(BaseKLStore):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        database = database or kwargs.get("database") or CM_AHVN.get("mdb.database")
        collection = collection or kwargs.get("collection") or CM_AHVN.get("mdb.default_args.collection")
        connection_args = {
            k: v
