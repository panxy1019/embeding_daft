...
def google_download(
    file_id: str, path: str, http_proxy: Optional[str] = None, https_proxy: Optional[str] = None, no_proxy: Optional[str] = None, *args, **kwargs
) -> Optional[str]:
    """\
    ...
    try:
        ...
        with NetworkProxy(http_proxy=http_proxy, https_proxy=https_proxy, no_proxy=no_proxy):
