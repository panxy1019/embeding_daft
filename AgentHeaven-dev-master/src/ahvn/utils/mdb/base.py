...
class MongoDatabase:
    ...
    - Uses resolve_mdb_config() to get configuration from CM_AHVN
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Similar to Database.__init__(), resolves configuration from CM_AHVN.
            ...
            self.conn.create_search_index(
                model={
                    ...
                    "definition": {
                        "fields": [
                            {
                                **CM_AHVN.get("mdb.vector_index", dict()),
