    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.inplace:
            ...
            database = kwargs.get("database") or CM_AHVN.get("mdb.default_args.database")
            collection = kwargs.get("collection") or self.name or CM_AHVN.get("mdb.default_args.collection")
