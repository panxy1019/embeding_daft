    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.inplace:
            ...
            provider = kwargs.get("provider") or CM_AHVN.get("vdb.default_provider")
            collection = kwargs.get("collection") or self.name or CM_AHVN.get(f"vdb.providers.{provider}.collection")
