...
VDB_FIELD_TYPES = {
    ...
    "int": VdbIntegerType(),
    "bool": VdbBooleanType(),
    "short_text": VdbTextType(length=CM_AHVN.get("ukf.text.short", 255)),
    "medium_text": VdbTextType(length=CM_AHVN.get("ukf.text.medium", 2047)),
    "long_text": VdbTextType(length=CM_AHVN.get("ukf.text.long", 65535)),
