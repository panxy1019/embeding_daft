"""\
Configuration management commands for RubikSQL CLI.
"""
...
def register_config_commands(cli, cm: Optional["ConfigManager"] = None, name: str = "rubiksql"):
    """\
    ...
    def show_config(key, is_global, is_system):
        """\
        Show config values.
        """
